...
#Agregar a cache (usar memoria en lugar de disco, entrenamiento más rapido)
datos_entrenamiento = datos_entrenamiento.cache()
datos_pruebas = datos_pruebas.cache()

#Mostrar una imagen de los datos de pruebas, en este momento mostraremos la primera
